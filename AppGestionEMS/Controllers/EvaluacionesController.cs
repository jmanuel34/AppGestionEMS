...
namespace AppGestionEMS.Controllers
{
    public class EvaluacionesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CursoId,UserId,Convocatoria,nota_Pr,nota_Ev,nota_P1,nota_P2,nota_P3,nota_P4,nota_Final")] Evaluaciones evaluaciones)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CursoId,UserId,Convocatoria,nota_Pr,nota_Ev,nota_P1,nota_P2,nota_P3,nota_P4,nota_Final")] Evaluaciones evaluaciones)
        {
            if (ModelState.IsValid)
            {
