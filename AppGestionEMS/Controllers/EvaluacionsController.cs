...
namespace AppGestionEMS.Controllers
{
    public class EvaluacionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UsuarioId,CursoId,nota_Pr,nota_Ev,nota_P1,nota_P2,nota_P3,nota_P4,nota_Final,practica_Convalidada,examen_Convalidado")] Evaluacion evaluacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UsuarioId,CursoId,nota_Pr,nota_Ev,nota_P1,nota_P2,nota_P3,nota_P4,nota_Final,practica_Convalidada,examen_Convalidado")] Evaluacion evaluacion)
        {
            if (ModelState.IsValid)
            {
